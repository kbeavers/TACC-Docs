/ Doug James
/ http://portal.tacc.utexas.edu/tutorials/bashquickstart
<span style="font-size:225%; font-weight:bold;">Bash Users' Startup Files: Quick Start Guide</span><br>
<span style="font-size:90%"><i>Last update: May 29, 2019</i></span><br>
:markdown
	...
	* Set environment variables
	...
	<pre class="cmd-line">$ <b>/usr/local/startup_scripts/install_default_scripts</b></pre>
