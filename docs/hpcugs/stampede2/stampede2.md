		...
		:markdown
			...
			*  sets up a tunnel through the login node to the vncserver access port 
			...
			1. Create an SSH Tunnel to Stampede2 
				...
				<pre class="cmd-line">
				localhost$ <b>ssh -f -N -L <i>xxxx</i>:localhost:<i>yyyy</i> <i>username</i>@stampede2.tacc.utexas.edu</b></pre>
...
#programming
	...
	#programming-general
		...
		#programming-general-timingprofiling
			:markdown
		...
		#programming-general-datalocality
			:markdown
		...
		#programming-general-vectorization
			:markdown
	...
	#programming-knl
		...
		#programming-knl-architecture
			:markdown
				...
				Each core has its own local L1 cache (32KB, data, 32KB instruction) and two 512-bit vector units. Both vector units can execute `AVX512` instructions, but only one can execute legacy vector instructions (`SSE`, `AVX`, and `AVX2`). Therefore, to use both vector units, you must compile with <span style="white-space: nowrap;">`-xMIC-AVX512`</span>.
		...
		#figure4
			:markdown
				<figure><p><img alt="KNL Memory Modes" src="/documents/10157/1334612/KNL+Memory+Modes.png/f19c64b8-6007-4a08-a6f3-80cabf9a2c20" style="width: 800px; height: 171px;" /><figcaption>Figure 4. KNL Memory Modes</figcaption></figure>
		...
		#figure5
			:markdown
				<figure><p><img alt="KNL Cluster Modes" src="/documents/10157/1334612/KNL+Cluster+Modes.png/142c5092-c736-48ea-a3cc-f3d9d3f43647" style="width: 800px; height: 274px;" /><figcaption>Figure 5. KNL Cluster Modes</figcaption></figure>
		...
		#programming-knl-managingmemory
			:markdown
