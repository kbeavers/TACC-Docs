...
echo "building Lonestar6 user guide for TACC"
title="<h1\>Lonestar6\ User\ Guide<\/h1\>"
...
submitticket="http:\/\/portal.tacc.utexas.edu\/tacc-consulting\/-\/consult\/tickets\/create"
