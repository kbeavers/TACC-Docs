#files
	:markdown
		# [Managing Files on Lonestar6](#files)


#files-table3
	:markdown
		## [Table 3. Lonestar6 File Systems](#files-table3)
...
%table(border="1" cellpadding="5" cellspacing="3")
	...
	%tr
		%td <code>$HOME</code>
		%td 10 GB
		%td 200,000 files<br><b>Not intended for parallel or high-intensity file operations.</b><br>NFS file system<br>Backed up regularly.<br>Overall capacity 7 TB<br>Not purged.

	%tr
		%td <code>$WORK</code>
		%td 1 TB<br>3,000,000 files<br>Across all TACC systems
	...
	%tr
		...
		%td none
		%td Overall capacity 8 PB<br>Defaults: 4 targets, 512 KB chunk size<br>Not backed up<br><b>Files are subject to purge if access time* is more than 10 days old.</b><sup><a href="#sup1">&#42;</a></sup>
	%tr
		%td <code>/tmp</code> on nodes
		%td 288 GB
		%td Data purged at the end of each job.<br>Access is local to the node.<br>Data in /tmp is not shared across nodes.
...
#files-transferring-scp
	:markdown
		### [Transferring Files with `scp`](#files-transferring-scp)
...
#transferring-files-rsync
	:markdown
		### [Transferring Files with `rsync`](#files-transferring-rsync)
